<x-auth-layout>
    <div class="w-full h-full rounded card-auth ">
                ...
                @endif
        {{-- Header --}}
        <div class="flex w-full flex-col items-center justify-center mb-3 form-group text-white">
            <h1 class="mt-2 text-xl xl:text-3xl 2xl:text-5xl font-bold">Selamat Datang</h1>
        </div>
    
        {{-- Forms --}}
        <div class="flex w-full flex-col items-center justify-center mb-3 form-group ">
            <form action="{{route('proses_register')}}" method="post" class="space-y-5">
                @csrf
                <div class="flex flex-col mt-3  form-group">
                    <div class="flex justify-center items-center relative input-group w-full text-darkGray">
                        <select class="w-full py-3 lg:py-3 pr-4 lg:pr-8 pl-14 lg:pl-16 text-sm lg:text-lg font-bold rounded-lg outline-none active form-control" name="users" id="">    
                ...
                <div class="flex flex-col mt-3  form-group">
                    <div class="flex justify-center items-center relative input-group w-full text-darkGray">
                        <input type="text" name="fullname"
                            ...
                            id="" placeholder="Nama Lengkap" autocomplete="off">
                        <span class="absolute flex items-center justify-center h-full py-3 px-5 lg:px-6 inset-y-0 left-0">
                ...
                <div class="flex flex-col mt-3  form-group">
                    <div class="flex justify-center items-center relative input-group w-full text-darkGray">
                        <input type="text" name="phone"
                            class="w-full py-3 lg:py-3 pr-4 lg:pr-8 pl-14 lg:pl-16 text-sm lg:text-lg font-bold rounded-lg outline-none active form-control"
                            id="" placeholder="Nomor Telepon" autocomplete="off">
                        <span class="absolute flex items-center justify-center h-full py-3 px-5 lg:px-6 inset-y-0 left-0">
                ...
                <div class="flex w-full flex-col items-center justify-center mb-3 mt-3 form-group">
                    <button type="submit" class="flex text-white items-center justify-center shadow-xl w-full lg:w-32 focus:outline-none bg-dark hover:bg-darkGray py-3 lg:py-3 xl:px-16 2xl:px-20 rounded-lg font-medium text-sm xl:text-base 2xl:text-lg">Daftarkan</button>
                    <a href="/login" class="hover:underline mt-4 hover:font-bold hover:text-darkGray text-white">Login</a>
                </div>
